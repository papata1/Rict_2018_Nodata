...
<div class="panel panel-default" >
    <div class="panel-heading">
       <div class="col-lg-3"> ตารางระบบสารสนเทศ</div><div class="col-lg-7"></div>{{ link_to_route('app.create','เพิ่มระบบสารสนเทศ',null,['class'=>'btn btn-success']) }}
    </div>
    <!-- /.panel-heading -->
