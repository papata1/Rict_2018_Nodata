       ...
       <div class="row">
        ...
        'files' => true)) !!}
                      ...
                      <div class="form-group">
                        ...
                        &nbsp;{!! Form::radio('category','ระบบสารสนเทศภายในองค์กร','true') !!} ระบบสารสนเทศภายในองค์กร 
                      ...
                      <div class="form-group">
                        {!! Form::label('ma_cost','ค่าซ่อมบำรุง') !!}
                          {!! Form::text('ma_cost',null,['class'=>'form-control']) !!}
                           ...
                           <div class="form-group">
                                        {!! Form::label('data','ER-Diagram') !!}
                                        {!! Form::file('data',null,['class'=>'form-control']) !!}
                                    </div>
                                    <div class="form-group">
                                        {!! Form::label('dic','Data Dictionary') !!}
                                        {!! Form::file('dic',null,['class'=>'form-control']) !!}
                                    </div>
                                     <div class="form-group">
                                        {!! Form::label('pic','รูปหน้าจอ') !!}
