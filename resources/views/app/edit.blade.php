               ...
               <div class="panel panel-default">
                   ...
                   <div class="panel-body">
                     ...
                     {!! Form::model($app,array('route'=>['app.update',$app->id],'method'=>'PUT','novalidate' => 'novalidate','files' => true)) !!}
                      ...
                      <div class="form-group">
                        {!! Form::label('category','ประเภทของระบบ') !!}&nbsp;
                        &nbsp;{!! Form::radio('category','ระบบสารสนเทศภายในองค์กร') !!} ระบบสารสนเทศภายในองค์กร 
                        &nbsp;{!! Form::radio('category','ระบบสารสนเทศภายนอกองค์กร') !!} ระบบสารสนเทศภายนอกองค์กร 
                      </div>
                       <div class="form-group">
                           {!! Form::label('department_id','หน่วยงานที่รับผิดชอบ') !!}
                           {!! Form::select('department_id',['' => ''] + $items1, null, ['class' => 'form-control datar']) !!}
                      </div>
                      <div class="form-group">
                        {!! Form::label('getting_start_years','ปีที่เริ่มพัฒนา') !!}
{!! Form::select('getting_start_years',['' => ''] + $year,null,['class'=>'form-control datar']) !!}
                      </div>
                      <!--  <div class="form-group">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                           ...
                           @if ($app->data)
                               {!! Form::label('file','ER-Diagram') !!}<br>
                               <p><a href="{{ action('AppController@download' ,[$app->data]) }}">{{$app->data}}</a></p>
                               {!! Form::file('file',null,['class'=>'form-control']) !!}
                           @else

                               {!! Form::label('file','ER-Diagram') !!}<br ><p>ไม่มีไฟล์ </p>
                               {!! Form::file('file',null,['class'=>'form-control']) !!}
                           @endif
                       ...
                       <div class="form-group">
                           ...
                           @if ($app->pic)
                               {!! Form::label('pic','รูปหน้าจอ') !!}<br>
                               <p><img src="{{ URL::to('/') }}/images/app/{{ $app->pic }}"  width="600" height="600" /></p>
                               {!! Form::file('pic',null,['class'=>'form-control']) !!}<p></p>
                           @else

                               {!! Form::label('pic','รูปหน้าจอ') !!}<br ><p>ไม่มีไฟล์ </p>
                    ...
                    <div class="form-group">
                       ...
                       {!! Form::label('','ภาษาที่ใช้พัฒนา') !!}</div>
                       <?php
                               $namelangg = "";
                               ?>
                       <div class="panel panel-default" >
                               ...
                               <table width="100%" class="table">
                                   ...
                                   @foreach($ls as $it)
                                       ...
                                       <?php  
                                           ...
                                           <td>{{ $it->name}}  </td>
                                           <td>
<button type="submit" class="btn btn-danger delre" data-id="{{$it->id}}"><span class="glyphicon glyphicon-remove"></span></button>
                                           </td>
                                       </tr>
                                   @endforeach
                                   </tbody>
                                   ...
                                   <table width="100%" class="table">
                                       ...
                                       @foreach($aps as $a)
                                           <tr>
                                               <td>{{ $a->name}}  </td>
                                               <td>
<button type="submit" class="btn btn-danger delre" data-id="{{$a->id}}"><span class="glyphicon glyphicon-remove"></span></button>
                                               </td>
                                           </tr>
                                       @endforeach
                                       </tbody>
                                   ...
                                   <table width="100%" class="table">
                                       ...
                                       @foreach($ds as $d)
                                           <tr>
                                               <td>{{ $d->name}}  </td>
                                               <td>
<button type="submit" class="btn btn-danger delre" data-id="{{$d->id}}"><span class="glyphicon glyphicon-remove"></span></button>
                                               </td>
                                           </tr>
                                       @endforeach
                                       </tbody>
                               ...
                               <table width="100%" class="table">
                                   ...
                                   @foreach($ts as $t)
                                       <tr>
                                           <td>{{ $t->name}}  </td>
                                           <td>
<button type="submit" class="btn btn-danger delre" data-id="{{$t->id}}"><span class="glyphicon glyphicon-remove"></span></button>
                                           </td>
                                       </tr>
                                   @endforeach
                                   </tbody>
                       ...
                       <div class="form-group">
                           {!! Form::label('state','สถานะ') !!}
                           {!! Form::select('state',['' => ''] + $state, null, ['class' => 'form-control datar']) !!}
                       </div>
                   ...
                   <div class="form-group">
                       ...
                       {!! Form::hidden('lang3', null,['id' => 'lang3']) !!}
 {!! Form::hidden('q', null,['class' => 'q']) !!}
