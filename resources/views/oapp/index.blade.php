...
<div class="panel panel-default" >
    <div class="panel-heading">
          ...
          {{ link_to_route('oapp.create','เพิ่มข้อมูล',null,['class'=>'btn btn-success']) }}
    </div>
    <!-- /.panel-heading -->
            ...
            <tr>
              ...
              <tbody>
                ...
                <tr>
                     <td>{{ $place->name}}  </td>
                         <td>
                           {!! Form::open(array('route'=>['oapp.destroy',$place->id],'method'=>'DELETE')) !!}
                        {{ link_to_route('oapp.edit','แก้ไข',[$place->id],['class'=>'btn btn-primary','id'=>'a']) }}
