           ...
           <div class="col-md-6 col-md-offset-1"><br>
               ...
               <div class="panel panel-default">
                   ...
                   <div class="panel-body">
                     ...
                     {!! Form::model($place,array('route'=>['oapp.update',$place->id],'method'=>'PUT','novalidate' => 'novalidate','files' => true)) !!}
                           ...
                           @if ($place->pic)
                               ...
                               <p><img src="{{ URL::to('/') }}/images/oapp/{{ $place->pic }}"  width="500" height="500" /></p>
                           ...
                           @if ($place->data)
                               ...
                               <p><a href="{{ action('OappController@download' ,[$place->data]) }}">{{$place->data}}</a></p>
                           ...
                           @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        {{ link_to_route('oapp.index','ย้อนกลับ',null,['class'=>'btn btn-danger']) }}
                                    </div>
                                {!! Form::close() !!}
