...
@if($model->pic)
                                                              ...
                                                              target="_blank"
                                                 href="{{ URL::to('/') }}/images/network/{{ $model->pic }}"
                                                   >เรียกดูรูป</a>
                                                   @else
                                                   <div>ไม่มีรูป</div>
                                                   @endif
...
@if($model->data)
							<a class="button btn btn-success" 
												href="{{ action('Technology_networkController@download' ,[$model->data]) }}"		
										   >ดาวน์โหลดเอกสาร</a>
@else
<div>ไม่มีไฟล์</div>
@endif
			...
			<!-- end: JAVASCRIPTS REQUIRED FOR THIS PAGE ONLY -->
			 <script>
										   ...
										   <script>
											   function dload() {
												   window.location="{{ asset('/downloadbus/'.$model->data) }}";
											   }
										   </script>
										   <script>
											   function newwin() {
												   Image = window.open('{{ URL::to('/') }}/images/network/{{ $model->pic }}','Image');
											   }
										   </script>
