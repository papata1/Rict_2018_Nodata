           ...
           <div class="col-md-6 col-md-offset-1"><br>
               ...
               <div class="panel panel-default">
                   ...
                   <div class="panel-body">
                     ...
                     {!! Form::model($place,array('route'=>['otech.update',$place->id],'method'=>'PUT','novalidate' => 'novalidate','files' => true)) !!}
                        ...
                        <div class="form-group">
                           ...
                           @if ($place->pic)
                               ...
                               <p><img src="{{ URL::to('/') }}/images/otech/{{ $place->pic }}"  width="500" height="500" /></p>
                           ...
                           @if ($place->data)
                               ...
                               <p><a href="{{ action('OtechController@download' ,[$place->data]) }}">{{$place->data}}</a></p>
