...
<div class="panel panel-default" >
    ...
    <div class="panel-body" style="margin-right:20px;">
        ...
        <select id="master" name="master" class="form-control info">
            ...
            <option value="g" href="{{ url ('state') }}" selected=\"selected\">สถานะ</option>
...
<div class="panel panel-default" >
    <div class="panel-heading">
          <div class="col-lg-2">ตารางสถานะ</div> <div class="col-lg-8"></div>{{ link_to_route('state.create','เพิ่มสถานะ',null,['class'=>'btn btn-success']) }}
    </div>
    <!-- /.panel-heading -->
    <div class="panel-body" style="margin-right:20px;">
            ...
            <tr>
              ...
              <tbody>
                ...
                <tr>
                     <td>{{ $place->name}}  </td>
                         <td>
                           {!! Form::open(array('route'=>['state.destroy',$place->id],'method'=>'DELETE')) !!}
                        {{ link_to_route('state.edit','แก้ไข',[$place->id],['class'=>'btn btn-primary','id'=>'a']) }}
