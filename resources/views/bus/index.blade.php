              ...
              <tbody>
                ...
                <tr>
                    <td class="col-lg-1">
                        ...
                        {{ $bus->lv1}}{{ $bus->lv2}}{{ $bus->lv3}}{{ $bus->ids}}
                      </td>
...
<?php $a = 0; ?>
                         ...
                         <td class="col-lg-3">
                           {!! Form::open(array('route'=>['bus.destroy',$bus->id],'method'=>'DELETE')) !!}
                             <button type="button" class="btn btn-default pic" data-id="{{ $bus->name}}" src="{{ URL::to('/') }}/images/bus/{{$bus->workflow_path}}"><i class="fa fa-file-image-o po7" aria-hidden="true"></i></button>
                           <button type="button" class="btn btn-default add"  data-toggle="modal" data-target="#Add" data-id="{{ $bus->id}}" data-id1="{{ $bus->n1}}  {{ $bus->n2}}  {{ $bus->n3}}"  data-id2="{{ $bus->workflow_path}}"   
                           data-id3="{{ $bus->remark}}"
                                   data-id36="{{ $bus->lv1}}{{ $bus->lv2}}{{ $bus->lv3}}{{ $bus->id}}"
                                   data-id5="{{ $bus->name}}"  data-id20="{{ $bus->type}}"data-id31="{{ $bus->ids}}"
