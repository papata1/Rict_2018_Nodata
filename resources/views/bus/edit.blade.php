                   ...
                   <div class="panel-body">
                     ...
                     {!! Form::model($bus,array('route'=>['bus.update',$bus->id],'method'=>'PUT','novalidate' => 'novalidate','files' => true)) !!}
                             ...
                             <div class="form-group">
                                       ...
                                       <br>
                                       {{ $buss->lv1}}{{ $buss->lv2}}{{ $buss->lv3}}{{ $buss->ids}}
                                   </div>
                       ...
                       <div class="form-group">
                                    ...
                                    @if ($bus->workflow_file)
                                       {!! Form::label('dic','รูปกระบวนการทำงาน jpg,png,pdf') !!}<br>
                                       <p><img src="{{ URL::to('/') }}/images/bus/{{ $bus->workflow_file }}"  width="600" height="600" /></p>
                                        {!! Form::file('dic',null,['class'=>'form-control']) !!}
                                    @else

                                        {!! Form::label('dic','รูปกระบวนการทำงาน jpg,png,pdf') !!}<br ><p>ไม่มีรูปภาพ</p>
                                        {!! Form::file('dic',null,['class'=>'form-control']) !!}
                                   @endif
                                   <br><br>
                                   @if ($bus->workflow_path)
                                       {!! Form::label('file','ไฟล์กระบวนการทำงาน excel,word') !!}<br>
                                       <p><a href="{{ action('BusController@download' ,[$bus->workflow_path]) }}">{{$bus->workflow_path}}</a></p>
                                    
                                        {!! Form::file('file',null,['class'=>'form-control']) !!}
                                    @else

                                        {!! Form::label('file','ไฟล์กระบวนการทำงาน excel,word') !!}<br ><p>ไม่มีไฟล์ </p>
                                        {!! Form::file('file',null,['class'=>'form-control']) !!}
                                   @endif
...
{!! Form::hidden('q', null,['class' => 'q']) !!}
                           {!! Form::hidden('short',$bus->short_name) !!}
                                    </div>
