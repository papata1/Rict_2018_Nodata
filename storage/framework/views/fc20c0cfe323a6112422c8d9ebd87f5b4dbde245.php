...
<div class="panel panel-default" >
    ...
    <div class="panel-body" style="margin-right:20px;">
        ...
        <select id="master" name="master" class="form-control info">
            ...
            <option value="i" href="<?php echo e(url ('devg')); ?>"  selected=\"selected\">บริษัทที่พัฒนา</option>
        </select>
    </div></div>
    </div>
    <!-- /.panel-body -->
...
<div class="panel panel-default" >
    <div class="panel-heading">
        <div class="col-lg-2">ตารางบริษัทที่พัฒนา</div><div class="col-lg-8"></div><?php echo e(link_to_route('devg.create','เพิ่มบริษัทพัฒนา',null,['class'=>'btn btn-success'])); ?>
        ...
        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
          <thead>
            <tr>
              ...
              <tbody>
                <?php $__currentLoopData = $devg1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $devg): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                <tr>
                     <td><?php echo e($devg->name); ?>  </td>

                    <td>
                           <?php echo Form::open(array('route'=>['devg.destroy',$devg->id],'method'=>'DELETE')); ?>

                        <?php echo e(link_to_route('devg.edit','แก้ไข',[$devg->id],['class'=>'btn btn-primary','id'=>'a'])); ?>
