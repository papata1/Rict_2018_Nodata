                   ...
                   <div class="panel-body">
                     ...
                     <?php echo Form::model($app,array('route'=>['app.update',$app->id],'method'=>'PUT','novalidate' => 'novalidate','files' => true)); ?>
                      ...
                      <div class="form-group">
                        ...
                        &nbsp;<?php echo Form::radio('category','ระบบสารสนเทศภายในองค์กร'); ?> ระบบสารสนเทศภายในองค์กร 
...
<?php echo Form::select('getting_start_years',['' => ''] + $year,null,['class'=>'form-control datar']); ?>
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                           ...
                           <?php if($app->data): ?>
                               <?php echo Form::label('file','ER-Diagram'); ?><br>
                           ...
                           <?php else: ?>
                               ...
                               <?php echo Form::label('file','ER-Diagram'); ?><br ><p>ไม่มีไฟล์ </p>
                               <?php echo Form::file('file',null,['class'=>'form-control']); ?>
                       ...
                       <div class="form-group">
                           ...
                           <?php if($app->dic): ?>
                               <?php echo Form::label('dic','Data Dictionary'); ?><br>
                           ...
                           <?php else: ?>
                               ...
                               <?php echo Form::label('dic','Data Dictionary'); ?><br ><p>ไม่มีไฟล์ </p>
                               ...
                               <table width="100%" class="table">
                                   ...
                                   <?php $__currentLoopData = $ls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                       ...
                                       <?php  
                                           ...
                                           <td>
<button type="submit" class="btn btn-danger delre" data-id="<?php echo e($it->id); ?>"><span class="glyphicon glyphicon-remove"></span></button>
                                           </td>
                                       </tr>
                                   ...
                                   <table width="100%" class="table">
                                       ...
                                       <?php $__currentLoopData = $aps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                           <tr>
                                               ...
                                               <td>
<button type="submit" class="btn btn-danger delre" data-id="<?php echo e($a->id); ?>"><span class="glyphicon glyphicon-remove"></span></button>
                                               </td>
                                           </tr>
                                       <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                       </tbody>
                                   ...
                                   <table width="100%" class="table">
                                       ...
                                       <?php $__currentLoopData = $ds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                           <tr>
                                               ...
                                               <td>
<button type="submit" class="btn btn-danger delre" data-id="<?php echo e($d->id); ?>"><span class="glyphicon glyphicon-remove"></span></button>
                                               </td>
                                           </tr>
                                       <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                       </tbody>
                               ...
                               <table width="100%" class="table">
                                   ...
                                   <?php $__currentLoopData = $ts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                       <tr>
                                           ...
                                           <td>
<button type="submit" class="btn btn-danger delre" data-id="<?php echo e($t->id); ?>"><span class="glyphicon glyphicon-remove"></span></button>
                                           </td>
                                       </tr>
                                   <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                   </tbody>
 ...
 <?php echo Form::hidden('q', null,['class' => 'q']); ?>
