...
<div class="container">
       <div class="row">
        ...
        'files' => true)); ?>
                                    ...
                                    <div class="form-group">
                                      <?php echo e(Form::label('dic','รูปกระบวนการทำงาน jpg,png,pdf')); ?>

                                      <?php echo e(Form::file('dic',null,['class'=>'form-control'])); ?>

                                    </div>
                                    <div class="form-group">
                                        <?php echo Form::label('file','ไฟล์กระบวนการทำงาน excel,word'); ?>
