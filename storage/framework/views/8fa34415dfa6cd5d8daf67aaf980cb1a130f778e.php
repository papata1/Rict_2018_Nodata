           ...
           <div class="col-md-6 col-md-offset-1"><br>
               ...
               <div class="panel panel-default">
                   ...
                   <div class="panel-body">
                     ...
                     <?php echo Form::model($place,array('route'=>['otech.update',$place->id],'method'=>'PUT','novalidate' => 'novalidate','files' => true)); ?>
                        ...
                        <div class="form-group">
                           ...
                           <?php if($place->pic): ?>
                               ...
                               <p><img src="<?php echo e(URL::to('/')); ?>/images/otech/<?php echo e($place->pic); ?>"  width="500" height="500" /></p>
                           ...
                           <?php if($place->data): ?>
                               ...
                               <p><a href="<?php echo e(action('OtechController@download' ,[$place->data])); ?>"><?php echo e($place->data); ?></a></p>
                           ...
                           <?php endif; ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo e(link_to_route('otech.index','ย้อนกลับ',null,['class'=>'btn btn-danger'])); ?>
