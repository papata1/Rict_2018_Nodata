...
<class="container">
        <div class="form-group"><h1 style="font-size:38px;">ข้อมูล
                </h1></div>
...
<div class="panel panel-default" >
    <div class="panel-heading">
           ...
           <?php echo e(link_to_route('odata.create','เพิ่มข้อมูล',null,['class'=>'btn btn-success'])); ?>
              ...
              <tbody>
                ...
                <tr>
                     <td><?php echo e($place->name); ?>  </td>
                         <td>
                           <?php echo Form::open(array('route'=>['odata.destroy',$place->id],'method'=>'DELETE')); ?>

                        <?php echo e(link_to_route('odata.edit','แก้ไข',[$place->id],['class'=>'btn btn-primary','id'=>'a'])); ?>
