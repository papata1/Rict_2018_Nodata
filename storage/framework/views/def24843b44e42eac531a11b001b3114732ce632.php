    ...
    <div class="panel panel-default" >
        ...
        <div class="panel-body" style="margin-right:20px;">
            ...
            <select id="master" name="master" class="form-control info">
                ...
                <option value="" href="<?php echo e(url ('lv2')); ?>" selected=\"selected\">กระบวนการระดับ 2</option>
...
<div class="panel panel-default" >
    <div class="panel-heading">
        <div class="col-lg-3">ตารางกระบวนการระดับ2</div><div class="col-lg-7"></div><?php echo e(link_to_route('lv2.create','เพิ่ม',null,['class'=>'btn btn-success'])); ?>
          ...
          <thead>
            <tr>
              ...
              <tbody>
                ...
                <tr>
                    <td><?php echo e($de->lv1); ?><?php echo e($de->short); ?></td>
                     <td><?php echo e($de->name); ?>  </td>

                         <td>
                           <?php echo Form::open(array('route'=>['lv2.destroy',$de->id],'method'=>'DELETE')); ?>

                        <?php echo e(link_to_route('lv2.edit','แก้ไข',[$de->id],['class'=>'btn btn-primary','id'=>'a'])); ?>
