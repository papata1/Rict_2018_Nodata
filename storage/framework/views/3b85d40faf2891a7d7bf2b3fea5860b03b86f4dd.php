...
<div class="panel panel-default ice">
  <div class="panel-body ">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
       ...
       <ul class="dropdown-menu">
        ...
        <li class="dropdown <?php echo e(Request::is('Bustype/1') ? 'active' : ''); ?>"><a href="<?php echo url('Bustype/1'); ?>">กระบวนการนักศึกษา</a></li>
        <li class="dropdown <?php echo e(Request::is('Bustype/2') ? 'active' : ''); ?>"><a href="<?php echo url('Bustype/2'); ?>">กระบวนการอาจารย์</a></li>
        <li class="dropdown <?php echo e(Request::is('Bustype/4') ? 'active' : ''); ?>"><a href="<?php echo url('Bustype/4'); ?>">กระบวนการฝ่ายสนับสนุนวิชาการ</a></li>
        <li class="dropdown <?php echo e(Request::is('Bustype/3') ? 'active' : ''); ?>"><a href="<?php echo url('Bustype/3'); ?>">กระบวนการสนับสนุน</a></li>
        <li class="dropdown <?php echo e(Request::is('Bustype/5') ? 'active' : ''); ?>"><a href="<?php echo url('Bustype/5'); ?>">กระบวนการอื่น ๆ</a></li>
      </ul>
    </li><li>&nbsp;&nbsp;</li>
    ...
    <ul class="dropdown-menu">
      ...
      <li role="separator" class="divider"></li>
      <li class="dropdown <?php echo e(Request::is('Dattype/1') ? 'active' : ''); ?>"><a href="<?php echo url('Dattype/1'); ?>">ข้อมูลฐานข้อมูลกลาง</a></li>
      <li class="dropdown <?php echo e(Request::is('Dattype/2') ? 'active' : ''); ?>"><a href="<?php echo url('Dattype/2'); ?>">ข้อมูลฐานข้อมูลอื่น</a></li>
      <li class="dropdown <?php echo e(Request::is('Dattype/3') ? 'active' : ''); ?>"><a href="<?php echo url('Dattype/3'); ?>">ข้อมูลอิเล็กทรอนิกส์ไฟล์</a></li>
      <li class="dropdown <?php echo e(Request::is('Dattype/4') ? 'active' : ''); ?>"><a href="<?php echo url('Dattype/4'); ?>">ข้อมูลเอกสาร</a></li>
    </ul>
  </li><li>&nbsp;&nbsp;</li>
  <li class="dropdown cusbtn btn-custom
