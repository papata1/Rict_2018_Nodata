...
<div class="panel panel-default" >
    ...
    <div class="panel-body" style="margin-right:20px;">
        ...
        <select id="master" name="master" class="form-control info">
            ...
            <option value="w" href="<?php echo e(url ('proc')); ?>" selected=\"selected\">ประเภทกระบวนการ</option>
            ...
            <option value="" href="<?php echo e(url ('InDat')); ?>">ตัวย่อข้อมูล</option>
                            <option value="" href="<?php echo e(url ('buslv1')); ?>">กระบวนการระดับ 1</option>
                <option value="" href="<?php echo e(url ('buslv1')); ?>" >กระบวนการระดับ 2</option>
                <option value="" href="<?php echo e(url ('buslv1')); ?>">กระบวนการระดับ 3</option>
        </select>
    </div></div>
    </div>
    <!-- /.panel-body -->
...
<div class="panel panel-default" >
    <div class="panel-heading">
        <div class="col-lg-3">ตารางประเภทกระบวนการ</div><div class="col-lg-6"></div><?php echo e(link_to_route('proc.create','เพิ่มประเภทกระบวนการ',null,['class'=>'btn btn-success'])); ?>
        ...
        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
          <thead>
            <tr>
              ...
              <tbody>
                <?php $__currentLoopData = $proc1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proc): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                <tr>
                     <td><?php echo e($proc->name); ?>  </td>
                    <td><?php echo e($proc->remark); ?>  </td>
                         <td>
                           <?php echo Form::open(array('route'=>['proc.destroy',$proc->id],'method'=>'DELETE')); ?>

                        <?php echo e(link_to_route('proc.edit','แก้ไข',[$proc->id],['class'=>'btn btn-primary','id'=>'a'])); ?>
