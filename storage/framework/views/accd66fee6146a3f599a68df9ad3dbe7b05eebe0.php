...
<div class="panel panel-default" >
    ...
    <div class="panel-body" style="margin-right:20px;">
        ...
        <select id="master" name="master" class="form-control info">
            ...
            <option value="g" href="<?php echo e(url ('state')); ?>" selected=\"selected\">สถานะ</option>
...
<class="container">
  			<div class="form-group"><h1 style="font-size:38px;">สถานะ
                </h1></div>
    ...
    <form action="stateImport" method = "post" enctype="multipart/form-data" >
...
<div class="panel panel-default" >
    <div class="panel-heading">
          <div class="col-lg-2">ตารางสถานะ</div> <div class="col-lg-8"></div><?php echo e(link_to_route('state.create','เพิ่มสถานะ',null,['class'=>'btn btn-success'])); ?>
              ...
              <tbody>
                ...
                <tr>
                     <td><?php echo e($place->name); ?>  </td>
                         <td>
                           <?php echo Form::open(array('route'=>['state.destroy',$place->id],'method'=>'DELETE')); ?>

                        <?php echo e(link_to_route('state.edit','แก้ไข',[$place->id],['class'=>'btn btn-primary','id'=>'a'])); ?>
