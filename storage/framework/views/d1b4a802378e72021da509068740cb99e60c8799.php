...
<div class="panel panel-default" >
    ...
    <div class="panel-body" style="margin-right:20px;">
        ...
        <select id="master" name="master" class="form-control info">
            ...
            <option value="a" href="<?php echo e(url ('brand')); ?>"  selected=\"selected\">ยี่ห้อ</option>
...
<div class="panel panel-default" >
    <div class="panel-heading">
       <div class="col-lg-2"> ตารางยี่ห้อ</div><div class="col-lg-9"></div><?php echo e(link_to_route('brand.create','เพิ่มยี่ห้อ',null,['class'=>'btn btn-success'])); ?>
              ...
              <tbody>
                ...
                <tr>
                     <td><?php echo e($brand->name); ?>  </td>
                         <td>
                           <?php echo Form::open(array('route'=>['brand.destroy',$brand->id],'method'=>'DELETE')); ?>

                        <?php echo e(link_to_route('brand.edit','แก้ไข',[$brand->id],['class'=>'btn btn-primary','id'=>'a'])); ?>
