							...
							<div class="col-md-12">
								...
								<div class="panel panel-default">
									<div style="height: 50px;padding:0" class="panel-heading">
										<div style="font-size:33px;">&nbsp;&nbsp;&nbsp;เทคโนโลยี</div>
									</div>
											...
											<table class="table table-bordered table-hover" id="myTable">
												<thead>
													<tr>
														...
														<th><center>ค่าซ่อมบำรุงต่อปี</center></th>
												...
												<tbody>
													...
													<tr onclick="document.location = '<?php echo url('main/TecDetail/'.$model->id); ?>';">
														<td><?php echo e($model->tecname); ?></td>
														<td>
														...
														<?php if($model->tecbrand==$modell2->id)echo$modell2->name; ?>
														<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
														</td>
														<td><?php echo e($model->tecmodel); ?></td>
														<td><?php echo e($model->tecspec); ?></td>
														<td><?php echo e($model->tecamount); ?></td>
														<td>
														...
														<?php if($model->teclocation==$modell3->id)echo$modell3->name; ?>
														<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
														</td>
														<td><?php echo e($model->tecma_cost); ?></td>
														<td><?php echo e($model->tecremark); ?></td>
...
$('#myTable').dataTable( {
    "paging": false
			...
			function myFunction() {
				var input, filter, table, tr, td0, td1, td2, td3, td4, td5, td6, td7, td8, i;
				...
				for (i = 0; i < tr.length; i++) {
					...
					if (td0 || td1 || td2 || td3 || td4 || td5 || td6 || td7) {
