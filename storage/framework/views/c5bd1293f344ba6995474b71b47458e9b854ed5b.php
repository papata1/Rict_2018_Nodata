           ...
           <div class="col-md-6 col-md-offset-1">.
               ...
               <div class="panel panel-default">
                   ...
                   <div class="panel-body">
                     ...
                     <?php echo Form::model($de,array('route'=>['de.update',$de->id],'method'=>'PUT','novalidate' => 'novalidate','files' => true)); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo e(link_to_route('de.index','ย้อนกลับ',null,['class'=>'btn btn-danger'])); ?>
