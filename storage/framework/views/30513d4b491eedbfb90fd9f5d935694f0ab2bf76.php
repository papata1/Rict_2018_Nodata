                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control txt1" name="addre1" id="rela7" disabled>
...
<div class="panel panel-default" >
    <div class="panel-heading">
       <div class="col-lg-3"> ตารางระบบสารสนเทศ</div><div class="col-lg-7"></div><?php echo e(link_to_route('app.create','เพิ่มระบบสารสนเทศ',null,['class'=>'btn btn-success'])); ?>
...
<?php if($app->id < 10 ): ?>
              <td><?php echo e($in1->initial); ?>00<?php echo e($app->id); ?> </td>
              <?php elseif($app->id < 100 ): ?>
              <td><?php echo e($in1->initial); ?>0<?php echo e($app->id); ?> </td>
             <?php else: ?>
              <td><?php echo e($in1->initial); ?><?php echo e($app->id); ?> </td>
              <?php endif; ?>
            ...
            <td><?php echo e($app->getting_start_years); ?>  </td>
              <td>
                  <?php $__currentLoopData = $devl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $de): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                      <?php if($app->id ==$de->id ): ?>
                          <?php echo e($de->develop_language); ?>
              ...
              <td  class="col-lg-3">
                  ...
                  <button type="button" class="btn btn-default add" data-toggle="modal" data-target="#Add" data-id="<?php echo e($app->id); ?>" data-id1="<?php echo e($app->name); ?>"   data-id2="<?php echo e($app->develop_language); ?>"
                  ...
                  <a href="<?php echo e(action('AppController@edit' ,[$app->id] )); ?>" class="btn btn-default po5" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
