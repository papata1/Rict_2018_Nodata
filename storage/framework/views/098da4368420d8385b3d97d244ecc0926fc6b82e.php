...
<div class="panel panel-default" >
    ...
    <div class="panel-body" style="margin-right:20px;">
        ...
        <select id="master" name="master" class="form-control info">
            ...
            <option value="d" href="<?php echo e(url ('coll')); ?>"  selected=\"selected\">ประเภทการเก็บข้อมูล</option>
            ...
            <option value="g" href="<?php echo e(url ('ud')); ?>">ฐานข้อมูลที่ใช้</option>
                ...
                <option value="" href="<?php echo e(url ('buslv2')); ?>" >กระบวนการระดับ 2</option>
                <option value="" href="<?php echo e(url ('buslv3')); ?>">กระบวนการระดับ 3</option>
        </select>
    </div></div>
    </div>
    <!-- /.panel-body -->
...
<div class="panel panel-default" >
    <div class="panel-heading">
        <div class="col-lg-3">ตารางประเภทการเก็บข้อมูล</div><div class="col-lg-6"></div><?php echo e(link_to_route('coll.create','เพิ่มประเภทการเก็บข้อมูล',null,['class'=>'btn btn-success'])); ?>
        ...
        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
          <thead>
            <tr>
              ...
              <tbody>
                <?php $__currentLoopData = $coll1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coll): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                <tr>
                     <td><?php echo e($coll->name); ?>  </td>
                         <td>
                           <?php echo Form::open(array('route'=>['coll.destroy',$coll->id],'method'=>'DELETE')); ?>

                        <?php echo e(link_to_route('coll.edit','แก้ไข',[$coll->id],['class'=>'btn btn-primary','id'=>'a'])); ?>
