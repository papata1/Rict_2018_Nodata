...
<div class="panel panel-default" >
    ...
    <div class="panel-body" style="margin-right:20px;">
        ...
        <select id="master" name="master" class="form-control info">
            ...
            <option value="r" href="<?php echo e(url ('lang')); ?>" selected=\"selected\">ภาษาที่ใช้พัฒนา</option>
...
<div class="panel panel-default" >
    <div class="panel-heading">
      <div class="col-lg-3">ตารางภาษาที่ใช้พัฒนา</div><div class="col-lg-6"></div><?php echo e(link_to_route('lang.create','เพิ่มภาษาที่ใช้พัฒนา',null,['class'=>'btn btn-success'])); ?>
        ...
        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
          <thead>
            <tr>
              ...
              <tbody>
                <?php $__currentLoopData = $lang1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                <tr>
                     <td><?php echo e($lang->name); ?>  </td>
                         <td>
                           <?php echo Form::open(array('route'=>['lang.destroy',$lang->id],'method'=>'DELETE')); ?>

                        <?php echo e(link_to_route('lang.edit','แก้ไข',[$lang->id],['class'=>'btn btn-primary','id'=>'a'])); ?>
