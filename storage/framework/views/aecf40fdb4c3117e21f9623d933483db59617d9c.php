    ...
    <div class="panel panel-default" >
        ...
        <div class="panel-body" style="margin-right:20px;">
            ...
            <select id="master" name="master" class="form-control info">
                ...
                <option value="" href="<?php echo e(url ('InApp')); ?>" selected=\"selected\" >ตัวย่อระบบสารสนเทศและข้อมูล</option>
          ...
          <thead>
            <tr>
              ...
              <tbody>
                        ...
                        <tr>
                         <td>
                            <?php echo e($brand2->name); ?>


                         </td>
                        <td>
                            <?php echo e($brand2->initial); ?>
