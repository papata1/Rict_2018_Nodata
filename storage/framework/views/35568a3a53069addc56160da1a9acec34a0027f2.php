										...
										<table class="table table-bordered table-hover" id="myTable">
											...
											<tbody>
												...
												<tr onclick="document.location = '<?php echo url('main/BusDetail/'.$model->blid); ?>';">
													<td width="50"><?php echo e($model->lv1); ?><?php echo e($model->lv2); ?><?php echo e($model->lv3); ?><?php echo e($model->ids); ?></td>
													<td><?php echo e($model->blname); ?></td>
													<td>
													<?php if($model->n1): ?>
													- <?php echo e($model->n1); ?><br>
													<?php endif; ?>
													<?php if($model->n2): ?>
													- <?php echo e($model->n2); ?><br>
													<?php endif; ?>
													<?php if($model->n3): ?>
													- <?php echo e($model->n3); ?><br>
													<?php endif; ?>
													...
													<td>
														...
														<?php
														if($modell3->business_layer_id == $model->blid){
