...
<?php $a = 0; ?>
                         ...
                         <td class="col-lg-2">
                           ...
                           <button type="button" class="btn btn-default add"  data-toggle="modal" data-target="#Add" data-id="<?php echo e($bus->id); ?>" data-id1="<?php echo e($bus->n1); ?> , <?php echo e($bus->n2); ?> , <?php echo e($bus->n3); ?>"  data-id2="<?php echo e($bus->workflow_path); ?>"   data-id3="<?php echo e($bus->remark); ?>"
                                   data-id36="<?php echo e($bus->lv1); ?><?php echo e($bus->lv2); ?><?php echo e($bus->lv3); ?><?php echo e($bus->id); ?>"
                                   data-id5="<?php echo e($bus->name); ?>"  data-id20="<?php echo e($bus->type); ?>"data-id31="<?php echo e($bus->ids); ?>"data-id32="<?php echo e($bus->remark); ?>"
