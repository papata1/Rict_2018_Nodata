...
<div class="container">
       <div class="row">
        ...
        'files' => true)); ?>
                      ...
                      <div class="form-group">
                        <?php echo Form::label('category','ประเภทของระบบ'); ?>&nbsp;
                        &nbsp;<?php echo Form::radio('category','ระบบสารสนเทศภายในองค์กร','true'); ?> ระบบสารสนเทศภายในองค์กร 
                        &nbsp;<?php echo Form::radio('category','ระบบสารสนเทศภายนอกองค์กร'); ?> ระบบสารสนเทศภายนอกองค์กร 
                      </div>
                      <div class="form-group">
                           <?php echo Form::label('department_id','หน่วยงานที่รับผิดชอบ'); ?>

                           <?php echo Form::select('department_id',['' => ''] + $items1, null, ['class' => 'form-control datar']); ?>

                      </div>
                      <div class="form-group">
                        <?php echo Form::label('getting_start_years','ปีที่เริ่มพัฒนา'); ?>

                        <?php echo Form::select('getting_start_years',['' => ''] + $year,null,['class'=>'form-control datar']); ?>
                       ...
                       <div class="form-group">
                           ...
                           <?php echo Form::select('app_database',['' => ''] + $usedata, null, ['class' => 'form-control datar','id' => 'asd']); ?>
                      ...
                      <div class="form-group">
                        <?php echo Form::label('ma_cost','ค่าซ่อมบำรุง'); ?>
                          ...
                          <?php echo Form::text('ma_cost',null,['class'=>'form-control']); ?>
                           ...
                           <div class="form-group">
                                        <?php echo Form::label('data','ER-Diagram'); ?>

                                        <?php echo Form::file('data',null,['class'=>'form-control']); ?>

                                    </div>
                                    <div class="form-group">
                                        <?php echo Form::label('dic','Data Dictionary'); ?>

                                        <?php echo Form::file('dic',null,['class'=>'form-control']); ?>

                                    </div>
                                     <div class="form-group">
                                        <?php echo Form::label('pic','รูปหน้าจอ'); ?>
                       ...
                       <div class="form-group">
                           <?php echo Form::label('','ภาษาที่ใช้พัฒนา'); ?>

                       </div>
                    <div class="form-group">
                       <select  id="langa" name="busRelation" class="datar">
                           <option value=""></option>
                           <?php $__currentLoopData = $lang4; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $la): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                               <option value="<?php echo e($la->id); ?>"><?php echo e($la->name); ?></option>
                    ...
                    <div class="form-group">
                       ...
                       <div class="form-group">
                           ...
                           <?php echo Form::label('department_id','ข้อมูล'); ?>
                   ...
                   <div class="form-group">
                       <select  id="tech" name="busRelation" class="datar">
                           <option value=""></option>
                           <?php $__currentLoopData = $tech456; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ts): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                   ...
                   <div class="form-group">
                       <select  id="de" name="busRelation" class="datar">
                           <option value=""></option>
                           <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                       ...
                       <div class="form-group">
                           <?php echo Form::label('state','สถานะ'); ?>

                           <?php echo Form::select('state',['' => ''] + $state, null, ['class' => 'form-control datar']); ?>
                       ...
                       <?php echo Form::hidden('devg2', null,['id' => 'devg2']); ?>

                       <?php echo Form::hidden('lop2', null,['id' => 'lop2']); ?>

                      <div class="form-group">
                        <?php echo Form::button('เพิ่มระบบสารสนเทศ',['type'=>'submit','class'=>'btn btn-primary','id' => 'add1']); ?>
...
<script>
    $(document).ready(function() {
        ...
        //------------------------------------------------------------------------------------------------------
        $('#langa').change(function () {
            // alert("aa");
            var aom = 0 ;
            var lang = document.getElementById("langa");
