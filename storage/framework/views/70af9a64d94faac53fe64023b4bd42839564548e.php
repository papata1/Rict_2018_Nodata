...
<div class="panel panel-default ice">
 ...
 <li role="separator" class="divider"></li>
    <li class="dropdown <?php echo e(Request::is('Busother') ? 'active' : ''); ?>"><a href="<?php echo url('Busother'); ?>">องค์ประกอบอื่นๆ (Other Artifacts)</a></li>
        </ul>
    </li><li>&nbsp;&nbsp;</li>
  ...
  <ul class="dropdown-menu">
    <li class="dropdown <?php echo e(Request::is('main/App') ? 'active' : ''); ?>"><a href="<?php echo url('main/App'); ?>">ระบบสารสนเทศทั้งหมด</a></li>
    <li role="separator" class="divider"></li>
    <li class="dropdown <?php echo e(Request::is('Apptype/1') ? 'active' : ''); ?>"><a href="<?php echo url('Apptype/1'); ?>">ระบบประเภทภายในองค์กร</a></li>
    <li class="dropdown <?php echo e(Request::is('Apptype/2') ? 'active' : ''); ?>"><a href="<?php echo url('Apptype/2'); ?>">ระบบประเภทภายนอกองค์กร</a></li>
     <li role="separator" class="divider"></li>
      <li class="dropdown <?php echo e(Request::is('Apptype/excel') ? 'active' : ''); ?>"><a href="<?php echo url('Apptype/excel'); ?>">Download Excel</a></li>
      <li role="separator" class="divider"></li>
      <li class="dropdown <?php echo e(Request::is('Appother') ? 'active' : ''); ?>"><a href="<?php echo url('Appother'); ?>">องค์ประกอบอื่นๆ (Other Artifacts)</a></li>
  </ul>
  ...
  <ul class="dropdown-menu">
    <li class="dropdown <?php echo e(Request::is('main/Dat') ? 'active' : ''); ?>"><a href="<?php echo url('main/Dat'); ?>">ข้อมูลทั้งหมด</a></li>
    
    <li role="separator" class="divider"></li>
      <li class="dropdown <?php echo e(Request::is('Datexcel') ? 'active' : ''); ?>"><a href="<?php echo url('Datexcel'); ?>">Download Excel</a></li>

      <li role="separator" class="divider"></li>
    <li class="dropdown <?php echo e(Request::is('Datother/') ? 'active' : ''); ?>"><a href="<?php echo url('Datother'); ?>">องค์ประกอบอื่นๆ (Other Artifacts)</a></li>
  </ul>
  ...
  <ul class="dropdown-menu">
    ...
    <li role="separator" class="divider"></li>
      <li class="dropdown <?php echo e(Request::is('Tectype/excel') ? 'active' : ''); ?>"><a href="<?php echo url('Tectype/excel'); ?>">Download Excel</a></li>

      <li role="separator" class="divider"></li>
      <li class="dropdown <?php echo e(Request::is('bui') ? 'active' : ''); ?>"><a href="<?php echo url('bui'); ?>">
   แผนผังอาคาร</a></li>
    <li role="separator" class="divider"></li>
     <li class="dropdown <?php echo e(Request::is('net') ? 'active' : ''); ?>"><a href="<?php echo url('net'); ?>">
      แผนผังระบบเครือข่าย</a></li>

      <li role="separator" class="divider"></li>
    <li class="dropdown <?php echo e(Request::is('Tecother') ? 'active' : ''); ?>"><a href="<?php echo url('Tecother'); ?>">องค์ประกอบอื่นๆ (Other Artifacts)</a></li>
  </ul>
</li><li>&nbsp;&nbsp;</li>
<li class="dropdown cusbtn btn-custom
