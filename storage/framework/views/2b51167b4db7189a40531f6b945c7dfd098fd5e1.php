...
<div class="panel panel-default" >
    <div class="panel-heading">
          ...
          <?php echo e(link_to_route('oapp.create','เพิ่มข้อมูล',null,['class'=>'btn btn-success'])); ?>
              ...
              <tbody>
                ...
                <tr>
                     <td><?php echo e($place->name); ?>  </td>
                         <td>
                           <?php echo Form::open(array('route'=>['oapp.destroy',$place->id],'method'=>'DELETE')); ?>

                        <?php echo e(link_to_route('oapp.edit','แก้ไข',[$place->id],['class'=>'btn btn-primary','id'=>'a'])); ?>
