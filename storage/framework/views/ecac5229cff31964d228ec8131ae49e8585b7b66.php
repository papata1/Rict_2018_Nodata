            ...
            <tr>
              ...
              <tbody>
                ...
                <tr>
                    <td class="col-lg-1">
                    <?php if($bus->ids < 10 ): ?>
                        <?php echo e($bus->remark); ?>0<?php echo e($bus->ids); ?>

                     <?php else: ?>
                        <?php echo e($bus->remark); ?><?php echo e($bus->ids); ?>

                    <?php endif; ?>   </td>
                     <td class="col-lg-3"><?php echo e($bus->name); ?>  </td>
                     <td class="col-lg-1"><?php echo e($bus->type1); ?>  </td>
                     <td class="col-lg-1">
                         ...
                         <td class="col-lg-2">
                           <?php echo Form::open(array('route'=>['bus.destroy',$bus->id],'method'=>'DELETE')); ?>
                             ...
                             <button type="button" class="btn btn-default pic" data-id="<?php echo e($bus->name); ?>" src="<?php echo e(URL::to('/')); ?>/images/bus/<?php echo e($bus->workflow_path); ?>"><i class="fa fa-file-pdf-o po7" aria-hidden="true"></i></button>
                           <button type="button" class="btn btn-default add"  data-toggle="modal" data-target="#Add" data-id="<?php echo e($bus->id); ?>" data-id1="<?php echo e($bus->name); ?>" data-id2="<?php echo e($bus->workflow_path); ?>"   data-id3="<?php echo e($bus->remark); ?>"
                                   data-id21=""
                                   data-id5="<?php echo e($bus->type1); ?>"  data-id20="<?php echo e($bus->type); ?>"data-id31="<?php echo e($bus->ids); ?>"data-id32="<?php echo e($bus->remark); ?>"
