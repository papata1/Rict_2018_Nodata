...
<?php if($model->pic): ?>
                                                              ...
                                                              target="_blank"
                                                 href="<?php echo e(URL::to('/')); ?>/images/otech/<?php echo e($model->pic); ?>"
                                                   >เรียกดูรูป</a>
                                                   <?php else: ?>
                                                   <div>ไม่มีรูป</div>
                                                   <?php endif; ?>
													...
													<?php if($model->data): ?>
												<a class="button btn btn-success" 
												href="<?php echo e(action('OtechController@download' ,[$model->data])); ?>"		
												   >ดาวน์โหลดเอกสาร</a>
<?php else: ?>
                                                   <div>ไม่มีไฟล์</div>
                                                   </center>
			...
			<!-- end: JAVASCRIPTS REQUIRED FOR THIS PAGE ONLY -->
			 <script>
										   ...
										   <script>
											   function newwin() {
												   Image = window.open('<?php echo e(URL::to('/')); ?>/images/otech/<?php echo e($model->pic); ?>','Image');
											   }
										   </script>
