        ...
        <ul class="nav" id="side-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li <?php echo e((Request::is('*typography') ? 'class="active"' : '')); ?>>
                    <a href="<?php echo e(url ('bulid')); ?>">&nbsp;&nbsp;&nbsp;แผนผังอาคาร</a>
                    </li>
                    <li <?php echo e((Request::is('*typography') ? 'class="active"' : '')); ?>>
                    <a href="<?php echo e(url ('network')); ?>">&nbsp;&nbsp;&nbsp;แผนผังระบบเครือข่าย</a>
                    </li>
                </li>
                </ul>
...
<div class="nav" id="side-menu">
                ...
                <ul class="nav nav-second-level">
                    <li <?php echo e((Request::is('*panels') ? 'class="active"' : '')); ?>>
                    <a href="<?php echo e(url ('obus')); ?>">สถาปัตยกรรมกระบวนการ</a>
                    </li>
                    <li <?php echo e((Request::is('*buttons') ? 'class="active"' : '')); ?>>
                    <a href="<?php echo e(url ('oapp' )); ?>">สถาปัตยกรรมสารสนเทศ</a>
                    </li>
                    <li <?php echo e((Request::is('*notifications') ? 'class="active"' : '')); ?>>
                    <a href="<?php echo e(url('odata')); ?>">สถาปัตยกรรมข้อมูล</a>
                    </li>
                    <li <?php echo e((Request::is('*typography') ? 'class="active"' : '')); ?>>
                    <a href="<?php echo e(url ('otech')); ?>">สถาปัตยกรรมเทคโนโลยี</a>
                    </li>
                </li>
