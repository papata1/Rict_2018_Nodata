						...
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								<div style="height: 50px;padding:0" class="panel-heading">
									<div style="font-size:33px;">&nbsp;&nbsp;&nbsp;แผนผังระบบเครือข่าย</div>
								</div>
...
<?php if($model->pic): ?>
                                                              ...
                                                              target="_blank"
                                                 href="<?php echo e(URL::to('/')); ?>/images/network/<?php echo e($model->pic); ?>"
                                                   >เรียกดูรูป</a>
                                                   <?php else: ?>
                                                   <div>ไม่มีรูป</div>
                                                   <?php endif; ?>
...
<?php if($model->data): ?>
							<a class="button btn btn-success" 
												href="<?php echo e(action('Technology_networkController@download' ,[$model->data])); ?>"		
										   >ดาวน์โหลดเอกสาร</a>
<?php else: ?>
<div>ไม่มีไฟล์</div>
<?php endif; ?>
			...
			<!-- end: JAVASCRIPTS REQUIRED FOR THIS PAGE ONLY -->
			 <script>
										   ...
										   <script>
											   function newwin() {
												   Image = window.open('<?php echo e(URL::to('/')); ?>/images/network/<?php echo e($model->pic); ?>','Image');
											   }
										   </script>
