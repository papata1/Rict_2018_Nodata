                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                           ...
                           <?php else: ?>
                               ...
                               <?php echo Form::label('file','พจนานุกรมฐานข้อมูล'); ?><br ><p>ไม่มีไฟล์ </p>
                               <?php echo Form::file('file',null,['class'=>'form-control']); ?>
                       ...
                       <div class="form-group">
                           ...
                           <?php if($app->dic): ?>
                               <?php echo Form::label('dic','รูปกระบวนการทำงาน'); ?><br>
                           ...
                           <?php else: ?>
                               ...
                               <?php echo Form::label('dic','รูปกระบวนการทำงาน'); ?><br ><p>ไม่มีไฟล์ </p>
