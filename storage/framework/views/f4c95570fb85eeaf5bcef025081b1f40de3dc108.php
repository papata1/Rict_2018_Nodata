...
<head>
								...
								<div class="panel-body">
									<div class="table-responsive">
										...
										<table class="table table-bordered table-hover" id="sample-table-1">
											<tr><td class="col-lg-3">รหัส</td><td><?php echo e($modell->pfix); ?><?php echo e($modell->alid); ?></td></tr>
											<tr><td>ชื่อ</td><td><?php echo e($modell->alname); ?></td></tr>
											<tr><td>>ประเภทของระบบ</td><td><?php echo e($modell->category); ?></td></tr>
											...
											<tr><td>เทคโนโลยีที่เกี่ยวข้อง</td>
												<td>
												<?php $__currentLoopData = $liste2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
												<a href="<?php echo url('main/TecDetail/'. $row["serid"] ); ?>">
												- <?php echo e($row["sername"]); ?></a><br>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
												</td>
											</tr>
											<tr><td>ฐานข้อมูล</td>
											...
											<tr><td>บริษัทที่พัฒนา</td>
												...
												<td><?php echo e($modell->develop_company); ?></td>
											</tr>
											...
											<tr><td>หน่วยงานที่เกี่ยวข้อง</td>
												<td>
													<?php $__currentLoopData = $model10; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modell10): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
													- <?php echo e($modell10->dpname); ?><br>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
												</td>
											</tr>
											...
											<tr><td width="200">สถานะ</td><td><?php echo e($modell->state); ?></td></tr>
	...
	<script>
		function pic() {
			Image = window.open('<?php echo e(URL::to('/')); ?>/images/app/<?php echo e($modell->pic); ?>','Image');
		}
	</script>
	<script>
		function dload() {
