...
<div class="container">
       <div class="row">
        ...
        'files' => true)); ?>
                                    ...
                                    <!-- <div class="form-group">
                                      <?php echo Form::label('type','ชนิดข้อมูล'); ?>

                                        <?php echo Form::select('type',['' => ''] + $list, null, ['class' => 'form-control datar']); ?>
                       ...
                       <div class="form-group">
                           <select  id="bus" name="busRelation" class="datar">
                               <option value=""></option>
                               <?php $__currentLoopData = $bus456; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bs): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                       ...
                       <?php echo Form::hidden('tech2', null,['id' => 'tech2']); ?>
                                    ...
                                    <div class="form-group">
                                        <?php echo Form::button('เพิ่มข้อมูล',['type'=>'submit','class'=>'btn btn-primary','id'=>'add1']); ?>
