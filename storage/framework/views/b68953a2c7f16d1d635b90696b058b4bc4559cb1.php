...
<body>
	...
	<script type="text/javascript" src="<?php echo e(URL::asset('js/jquery-1.5.1.min.js')); ?>"></script>
	<script type="text/javascript" src="<?php echo e(URL::asset('js/jquery.freezeheader.js')); ?>"></script>
	...
	<table id="maintable" class="data-table" border="1" style="background-color:white;">
		<thead>
			<tr><th style="background-color:white;"><center>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo url('/menurelation'); ?>">ย้อนกลับ<?php //echo$tablea."/".$tableb; ?></a>&nbsp;&nbsp;&nbsp;&nbsp;</center></th><?php $__currentLoopData = $modelb; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modellb): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>

				<th id="<?php echo e($modellb->id); ?>" style="background-color:#E6E6E6;">&nbsp;&nbsp;&nbsp;
					<a 
					<?php
					if($linkb!='') {
						echo'href="';
					...
					echo'">';
					?>
					<?php echo e($modellb->name); ?>

				</a>
				&nbsp;&nbsp;&nbsp;</th>

				<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?></tr>
			</thead>
			<?php $__currentLoopData = $modela; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modella): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
			<tr>
				<th id="<?php echo e($modella->id); ?>" style="background-color:#E6E6E6;">
					&nbsp;&nbsp;<a 
					<?php
					if($linka!='') {
						echo'href="';
					...
					echo'">';
					?>
					<?php echo e($modella->name); ?>

				</a>&nbsp;&nbsp;
			</th>
			<?php $__currentLoopData = $modelb; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modellb): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
			<td a="<?php echo e($modellb->id); ?>" b="<?php echo e($modella->id); ?>"><center>
				<?php $f=0; $n=0;
			...
			</center></td><?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
		</tr>
