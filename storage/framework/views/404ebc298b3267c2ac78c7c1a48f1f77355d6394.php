										...
										<table class="table table-bordered table-hover" id="myTable">
											<thead>
												<tr>
													...
													<th class="col-lg-1"><center>ภาษาที่ใช้</center></th>
											...
											<tbody>
												...
												<tr onclick="document.location = '<?php echo url('main/AppDetail/'.$model->alid); ?>';">
													<td><?php echo e($model->pfix); ?><?php echo e($model->alid); ?></td>
													<td><?php echo e($model->alname); ?></td>
													<td>
														<?php $__currentLoopData = $model3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modell2): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
														<?php
														if($model->alid == $modell2->compalid)
														{
															echo"- ".$modell2->laname."<br>";
														}
														?>
													...
													<td><?php echo e($model->algettingstartyear); ?></td>
													<td>
													...
													<td><?php echo e($model->alremark); ?></td>
												</tr>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
											</tbody>
										</table>
