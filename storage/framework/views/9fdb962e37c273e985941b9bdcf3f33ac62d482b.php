       ...
       <div class="row">
           <div class="col-md-6 col-md-offset-1"><br>
               ...
               <div class="panel panel-default">
                   ...
                   <div class="panel-body">
                     ...
                     <?php echo Form::open(array('route'=>'bulid.store','class' => 'form',
        ...
        'files' => true)); ?>
                                  ...
                                  <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <?php echo Form::label('pic','รูปแผนผังอาคาร png,jpg'); ?>
                                     ...
                                     <div class="form-group">
                                        <?php echo Form::label('data','ไฟล์แผนผังอาคาร excel,word,pdf'); ?>
