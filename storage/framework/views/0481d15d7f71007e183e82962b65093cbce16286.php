											...
											<table class="table table-bordered table-hover" id="myTable">
												<thead>
													<tr>
														...
														<th width="250"><center>ชื่อ</center></th>
												...
												<tbody>
													...
													<tr onclick="document.location = '<?php echo url('main/DatDetail/'.$model->datid); ?>';">
														<td><?php echo e($model->pfix); ?><?php echo e($model->id); ?></td>
														<td><?php echo e($model->datname); ?></td>
													<td class="col-lg-2">
													...
													<?php if($model->datid == $modell2->datid): ?>
													 - <?php echo e($modell2->stname); ?><br>
														<?php endif; ?>
														<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
													</td>
														<td><?php echo e($model->datremark); ?></td>
													</tr>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
												</tbody>
											</table>
