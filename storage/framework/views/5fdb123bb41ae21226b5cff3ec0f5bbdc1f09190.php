								...
								<div class="panel-body">
									<div class="table-responsive">
										...
										<table class="table table-bordered table-hover" id="sample-table-1">
											<tr><td class="col-lg-3">รหัส</td><td><?php echo e($modell->pfix); ?><?php echo e($modell->id); ?></td></tr>
											...
											<tr><td width="200">กระบวนการที่เกี่ยวข้อง</td>
												<td>
												<?php $__currentLoopData = $liste2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row2): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
												<a href="<?php echo url('main/BusDetail/'. $row2["blid"] ); ?>"> - <?php echo e($row2["blname"]); ?></a><br>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
												</td>
											</tr>
											<tr><td width="200">ระบบสารสนเทศที่เกี่ยวข้อง</td>
												...
												<a href="<?php echo url('main/AppDetail/'. $row["alid"] ); ?>"> - <?php echo e($row["alname"]); ?></a><br>
