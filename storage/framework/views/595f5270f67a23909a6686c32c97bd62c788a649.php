...
<class="container">
  			<div class="form-group"><h1 style="font-size:38px;">แผนผังอาคาร
                </h1></div>
...
<div class="panel panel-default" >
    <div class="panel-heading">
           <div class="col-lg-3">ตารางแผนผังอาคาร</div> <div class="col-lg-7"></div>
           <?php echo e(link_to_route('bulid.create','เพิ่มข้อมูล',null,['class'=>'btn btn-success'])); ?>
              ...
              <tbody>
                ...
                <tr>
                     <td><?php echo e($place->name); ?>  </td>
                         <td>
                           <?php echo Form::open(array('route'=>['bulid.destroy',$place->id],'method'=>'DELETE')); ?>

                        <?php echo e(link_to_route('bulid.edit','แก้ไข',[$place->id],['class'=>'btn btn-primary','id'=>'a'])); ?>
