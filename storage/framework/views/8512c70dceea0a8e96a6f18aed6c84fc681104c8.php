...
<class="container">
  			<div class="form-group"><h1 style="font-size:38px;">แผนผังระบบเครือข่าย
                </h1></div>
...
<div class="panel panel-default" >
    <div class="panel-heading">
           <div class="col-lg-4">ตารางแผนผังระบบเครือข่าย</div> <div class="col-lg-6"></div>
           <?php echo e(link_to_route('network.create','เพิ่มข้อมูล',null,['class'=>'btn btn-success'])); ?>
              ...
              <tbody>
                ...
                <tr>
                     <td><?php echo e($place->name); ?>  </td>
                         <td>
                           <?php echo Form::open(array('route'=>['network.destroy',$place->id],'method'=>'DELETE')); ?>

                        <?php echo e(link_to_route('network.edit','แก้ไข',[$place->id],['class'=>'btn btn-primary','id'=>'a'])); ?>
