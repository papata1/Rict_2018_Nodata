                   ...
                   <div class="panel-body">
                     ...
                     <?php echo Form::model($bus,array('route'=>['bus.update',$bus->id],'method'=>'PUT','novalidate' => 'novalidate','files' => true)); ?>
                             ...
                             <div class="form-group">
                                       ...
                                       <br>
                                       <?php echo e($buss->lv1); ?><?php echo e($buss->lv2); ?><?php echo e($buss->lv3); ?><?php echo e($buss->ids); ?>
                       ...
                       <div class="form-group">
                                    ...
                                    <?php if($bus->workflow_file): ?>
                                       <?php echo Form::label('dic','รูปกระบวนการทำงาน jpg,png,pdf'); ?><br>
                                       <p><img src="<?php echo e(URL::to('/')); ?>/images/bus/<?php echo e($bus->workflow_file); ?>"  width="600" height="600" /></p>
                                        <?php echo Form::file('dic',null,['class'=>'form-control']); ?>

                                    <?php else: ?>

                                        <?php echo Form::label('dic','รูปกระบวนการทำงาน jpg,png,pdf'); ?><br ><p>ไม่มีรูปภาพ</p>
                                        <?php echo Form::file('dic',null,['class'=>'form-control']); ?>

                                   <?php endif; ?>
                                   <br><br>
                                   <?php if($bus->workflow_path): ?>
                                       <?php echo Form::label('file','ไฟล์กระบวนการทำงาน excel,word'); ?><br>
                                       <p><a href="<?php echo e(action('BusController@download' ,[$bus->workflow_path])); ?>"><?php echo e($bus->workflow_path); ?></a></p>
                                    
                                        <?php echo Form::file('file',null,['class'=>'form-control']); ?>

                                    <?php else: ?>

                                        <?php echo Form::label('file','ไฟล์กระบวนการทำงาน excel,word'); ?><br ><p>ไม่มีไฟล์ </p>
                                        <?php echo Form::file('file',null,['class'=>'form-control']); ?>
...
<?php echo Form::hidden('q', null,['class' => 'q']); ?>
                           ...
                           <?php echo Form::hidden('short',$bus->short_name); ?>
