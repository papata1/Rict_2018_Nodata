                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="form-group">
                          ...
                          <div class="row">
                          <div class="col-sm-5" > <input type="text" class="form-control txt1" name="addre1" id="t16" size="60" disabled>  </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="form-group">
                            ...
                            <label for="addre">ค่าซ่อมบำรุง</label>
                            <div class="row">
                                <div class="col-sm-5" > <input type="text" class="form-control txt1" name="addre1" id="t116" size="60" disabled>  </div>
...
<div class="panel panel-default" >
    <div class="panel-heading">
        <div class="col-lg-3">ตารางระบบสารสนเทศ</div><div class="col-lg-5"></div><a href="<?php echo e(action('TechController@test' ,[$t ='1'] )); ?>" class="btn btn-primary">เพิ่มเครื่องแม่ข่าย</a>
             ...
             <td class="col-lg-3">
                 ...
                 <?php if($tech->type == 1): ?>
                  <button type="button" class="btn btn-default add"  data-toggle="modal" data-target="#Add" data-id="<?php echo e($tech->id); ?>" data-id1="<?php echo e($tech->name); ?>"   data-id2="<?php echo e($tech->tech_spec); ?>"
                          ...
                          data-id16="<?php echo e($tech->	ma_cost); ?>" data-id17="<?php echo e($tech->remark); ?>" data-id40="<?php echo e($tech->type); ?>" data-id41="<?php echo e($tech->owner); ?>"
