               ...
               <div class="panel panel-default">
                   ...
                   <div class="panel-body">
                     ...
                     <?php echo Form::model($bus,array('route'=>['bus.update',$bus->id],'method'=>'PUT','novalidate' => 'novalidate','files' => true)); ?>
                       ...
                       <div class="form-group">
                           <?php if($bus->type ==1 ): ?>
                               <td class="col-lg-1">S0<?php echo e($bus->ids); ?>  </td>
                           <?php elseif($bus->type ==2 ): ?>
                               <td class="col-lg-1">A0<?php echo e($bus->ids); ?>  </td>
                           <?php elseif($bus->type ==3 ): ?>
                               <td class="col-lg-1">C0<?php echo e($bus->ids); ?>  </td>
                           <?php elseif($bus->type ==4 ): ?>
                               <td class="col-lg-1">T0<?php echo e($bus->ids); ?>  </td>
                           <?php else: ?>
                               <td class="col-lg-1">O0<?php echo e($bus->ids); ?>  </td>
                           <?php endif; ?>
                       </div>
                       <div class="form-group">
                                     ...
                                     <div class="form-group">
                                      <?php echo Form::label('type','ประเภทกระบวนการ'); ?>
